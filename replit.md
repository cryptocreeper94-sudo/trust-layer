...
- **DarkWave Chronicles**: Social experiment and parallel life simulation with persistent world and emotion-driven AI. Players start in Modern era, unlock Medieval and Wild West eras through quests/participation. Each player has a separate estate per era. World runs in real-time - other players and smart NPCs shape all eras even while you're away. 3D estate viewer with React Three Fiber. Season 0 has 3 playable eras (Modern, Medieval, Wild West) with 15 factions, 21 quests, 9 NPCs, 15 city zones, 36 era-specific building templates.
