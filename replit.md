...
- **Chronochat (Community Hub)**: Standalone community platform at chronochat.io. White-labeled with community creation, channels, real-time WebSocket messaging, reactions, replies, file uploads, member management, and a bot framework. Tagline: "Connect across timelines. Chat beyond eras." Features cyan-to-purple gradient branding.
