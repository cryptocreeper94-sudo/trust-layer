...
const APP_URL_MAP: Record<string, string> = {
  ...
  "tradeworks-ai": "https://tradeworksai.io",
...
function getLocalEcosystemApps(): EcosystemApp[] {
  return [
    ...
    },
    {
      ...
      category: "Security",
      description: "Comprehensive blockchain security scanner. Analyze smart contracts, token safety, and on-chain activity across multiple chains.",
      hook: "Scan. Analyze. Trust.",
      tags: ["Security", "Scanner", "Smart Contracts", "Multi-Chain"],
      gradient: "from-green-500 to-emerald-600",
      verified: true,
      featured: true,
      users: "DarkWave Verified",
      url: "/guardian-scanner",
    },
    {
    ...
    },
    {
      ...
      tags: ["Security", "AI", "Verification", "Agents"],
      gradient: "from-emerald-500 to-green-600",
      verified: true,
      featured: true,
      users: "DarkWave Verified",
      url: "/guardian-agent-scanner",
    },
    {
      id: "torque",
      name: "Torque",
