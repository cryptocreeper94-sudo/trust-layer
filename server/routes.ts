...
function getLocalEcosystemApps(): EcosystemApp[] {
  return [
    ...
    },
    {
      ...
      name: "Orby",
      category: "Enterprise",
      description: "Dual blockchain verified venue operations command suite with geofencing, facial recognition clock-in for fraud protection, and direct integration with Orbit Staffing.",
      hook: "Venue Operations Command Suite",
