...
function getLocalEcosystemApps(): EcosystemApp[] {
  return [
    ...
    },
    {
      ...
      category: "Gaming",
      description: "Not a game. A life. Live your legacy through a persistent fantasy world with emotion-driven AI and living political simulation.",
      hook: "Live Your Legacy",
      tags: ["Gaming", "RPG", "AI", "Social"],
