...
const milestones = [
  { date: "Completed", title: "Testnet Launch", desc: "Full testnet with all core features", status: "completed" },
  { date: "NOW", title: "Season Zero BETA v0.1", desc: "Chronicles playable - Medieval Era, AI NPCs, Chronicle Proofs", status: "in_progress" },
  { date: "Coming Soon", title: "Security Audits", desc: "Guardian Protocol + external audits", status: "upcoming" },
  { date: "Approaching", title: "TGE (Token Launch)", desc: "Mainnet launch & token generation", status: "upcoming" },
  { date: "After Launch", title: "DeFi Suite Launch", desc: "DEX, Staking, Bridge go live", status: "planned" },
  { date: "Future", title: "Chronicles Expansion", desc: "20+ eras, full economy, mobile companion", status: "planned" },
  { date: "Future", title: "10 Eras Complete", desc: "All verifiable historical eras fully playable", status: "planned" }
];
          ...
          <div className="container mx-auto max-w-7xl relative">
            ...
            >
              ...
              >
                ...
                Token Generation Event: Approaching
