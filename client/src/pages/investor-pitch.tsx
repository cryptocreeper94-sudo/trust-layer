...
const tokenomics = [
  { label: "Total Supply", value: "100,000,000 DWC", color: "from-cyan-500 to-blue-600" },
  { label: "Presale Allocation", value: "15%", color: "from-purple-500 to-pink-600" },
  ...
  { label: "Treasury", value: "20%", color: "from-indigo-500 to-violet-600" },
  { label: "Liquidity", value: "10%", color: "from-pink-500 to-rose-600" }
];
          ...
          <div className="container mx-auto max-w-7xl relative">
            ...
            >
              ...
              >
                ...
                Token Generation Event: February 14, 2026
                ...
                <div className="p-8 md:p-12 text-center relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-white/60 mb-8 max-w-2xl mx-auto text-lg">
                      ...
                      before TGE on February 14, 2026.
                    </p>
