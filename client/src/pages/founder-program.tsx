...
<main className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="text-center mb-12">
          ...
          >
            Pay once. Get lifetime access. Receive 35,000 Signal on launch day.
          </motion.p>
        </div>
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-primary/10 to-purple-500/10 border border-primary/20 mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">Delivered to your wallet at launch</div>
                </div>
              </div>
            </div>
...
<div className="space-y-6">
            <GlassCard className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Connect your wallet to receive your 35,000 Signal airdrop on launch day.
              </p>
              <WalletButton />
              {isConnected && address && (
...
<GlassCard className="p-4">
        ...
        <GlassCard className="p-6 text-center max-w-2xl mx-auto">
          <h3 className="text-xl font-semibold text-white mb-2">Limited Time Program</h3>
