          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <GlassCard hover={false}>
              <div className="p-4 text-center">
                ...
                <div className="text-xs text-muted-foreground">DWT Allocated</div>
              </div>
            </GlassCard>
          </div>
        ...
        <Dialog open={showDialog} onOpenChange={setShowDialog}>
          ...
          <DialogContent className="bg-background border-white/10">
            ...
            <div className="space-y-4">
              ...
              />
              <Input
                placeholder="Token Allocation (DWT per member)"
            ...
            <GlassCard key={tier.id} className="p-5" data-testid={`card-tier-${tier.id}`}>
              ...
              <div className="grid grid-cols-3 gap-3 text-center">
                <div className="bg-white/5 rounded-lg p-2">
                  ...
                  <div className="text-[10px] text-muted-foreground">DWT/Member</div>
                </div>
                <div className="bg-white/5 rounded-lg p-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    {parseFloat(gift.amount).toLocaleString()} DWT • {gift.category} • {gift.reason || "No reason"}
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-2">
            ...
            <GlassCard key={airdrop.id} className="p-5" data-testid={`card-airdrop-${airdrop.id}`}>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span>{claimed.toLocaleString()} / {total.toLocaleString()} DWT</span>
                </div>
