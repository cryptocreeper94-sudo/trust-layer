...
import dagViz from "@assets/generated_images/abstract_visualization_of_directed_acyclic_graph_blockchain_consensus.jpg";
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                    ...
                    <div className="text-center p-3 rounded-lg bg-black/30 border border-white/10">
                      <div className="text-xs font-bold text-cyan-400">2. Get Test SIG</div>
