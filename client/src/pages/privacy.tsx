...
export default function Privacy() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: `All blockchain transactions are publicly visible on the Trust Layer. This includes transaction hashes, wallet addresses, amounts, and timestamps. This data is immutable and cannot be deleted. We recommend using separate wallets for privacy-sensitive activities.`
    },
    {
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  collect, use, and safeguard your information when you use Trust Layer.
                </p>
              </div>
            </div>
          </GlassCard>
