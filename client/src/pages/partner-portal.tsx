...
const MILESTONES = [
  { phase: "Season Zero", name: "BETA v0.1 (NOW)", period: "NOW - Jun 1, 2026", status: "current", items: ["Medieval Era playable", "AI NPCs live", "Chronicle Proofs", "Voice cloning", "Business storefronts"] },
