...
export default function Faucet() {
  ...
  const claimMutation = useMutation({
    ...
    onSuccess: (data: any) => {
      toast({
        title: "Tokens Sent!",
        description: `${formatAmount(data.amount)} DWT sent to your wallet`,
      });
        ...
        <div className="container mx-auto max-w-lg">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              Get free test DWT to build and experiment on DarkWave Chain
            </p>
          </motion.div>
          ...
          >
            <div className="p-3 rounded-xl bg-white/5 border border-white/10 text-center">
              ...
              <div className="text-[10px] text-muted-foreground">DWT per claim</div>
            </div>
            <div className="p-3 rounded-xl bg-white/5 border border-white/10 text-center">
                  ...
                  <div className="p-3 rounded-lg bg-cyan-500/10 border border-cyan-500/20">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="font-bold text-cyan-400">
                        {formatAmount(faucetInfo?.claimAmount || "1000000000000000000000")} DWT
                      </span>
                    </div>
                  </div>
          ...
          >
            <div className="p-3 rounded-xl bg-white/5 border border-white/10">
              ...
              <ul className="text-[10px] text-muted-foreground space-y-1">
                ...
                <li>2. Click "Get Free DWT" to receive test tokens</li>
