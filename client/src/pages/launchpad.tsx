    ...
    <GlassCard className="h-full">
      <div className="p-4">
        <div className="flex items-start justify-between mb-3">
          ...
          <Badge className={`text-[9px] ${token.status === 'live' ? 'bg-green-500/20 text-green-400' : 'bg-teal-500/20 text-teal-400'}`}>
            {token.status}
          </Badge>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
                    ...
                    <div className="p-3 rounded-lg bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/30">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            <Label className="text-xs">Soft Cap (SIG)</Label>
                          ...
                          <div>
                            <Label className="text-xs">Hard Cap (SIG)</Label>
          ...
          <GlassCard className="mt-8" glow>
            <div className="p-6 text-center">
              ...
              <h3 className="text-lg font-bold mb-2">Launch Fee: 0 SIG</h3>
