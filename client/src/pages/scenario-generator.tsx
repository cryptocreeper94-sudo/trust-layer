...
import crystalBallImg from "@assets/generated_images/scenario_generator_crystal_ball.jpg";
import balanceScaleImg from "@assets/generated_images/balance_scale_moral_judgment.jpg";
import emotionalWarriorImg from "@assets/generated_images/emotional_warrior_portrait.jpg";
import rippleEffectsImg from "@assets/generated_images/glowing_ripple_effects_water.jpg";
import mirrorPerspectivesImg from "@assets/generated_images/shattered_mirror_perspectives.jpg";
import tribalEmissaryImg from "@assets/generated_images/tribal_emissary_woman_portrait.jpg";
import tribalShamanImg from "@assets/generated_images/tribal_shaman_elder_portrait.jpg";
import tribalWarriorImg from "@assets/generated_images/tribal_warrior_man_portrait.jpg";
import tribalHealerImg from "@assets/generated_images/tribal_healer_woman_portrait.jpg";
import tribalHunterImg from "@assets/generated_images/tribal_hunter_man_portrait.jpg";
import tribalScoutImg from "@assets/generated_images/tribal_scout_woman_portrait.jpg";
import tribalElderImg from "@assets/generated_images/tribal_elder_chief_portrait.jpg";
import tribalBlacksmithImg from "@assets/generated_images/tribal_blacksmith_man_portrait.jpg";
import tribalMysticImg from "@assets/generated_images/tribal_mystic_woman_portrait.jpg";
import tribalMerchantImg from "@assets/generated_images/tribal_merchant_woman_portrait.jpg";
import tribalCouncilImg from "@assets/generated_images/tribal_council_man_portrait.jpg";
import tribalSoldierImg from "@assets/generated_images/tribal_soldier_woman_portrait.jpg";
    ...
    <div className="h-full">
      <div className="group relative rounded-2xl overflow-hidden h-full" style={{ background: 'linear-gradient(135deg, #00ffff, #8b5cf6, #ec4899)' }}>
        ...
        <div className="relative rounded-xl bg-black m-[2px] overflow-hidden h-[calc(100%-4px)] flex flex-col">
          ...
          <div className="relative aspect-[3/4] w-full overflow-hidden bg-gradient-to-b from-gray-900 to-black">
            <img 
              src={portrait} 
              alt={character.name}
          ...
          <div className="p-3 sm:p-4 bg-gradient-to-b from-black/80 to-black flex-1 flex flex-col">
            <div className="mb-2">
              <h4 className="font-display font-bold text-sm sm:text-base text-white drop-shadow-lg leading-tight truncate">{character.name}</h4>
              <p className="text-[9px] sm:text-[10px] text-cyan-400 font-medium uppercase tracking-wider truncate">{character.role}</p>
            </div>
            
            <p className="text-[9px] sm:text-[10px] text-gray-400 mb-2 italic line-clamp-2 flex-shrink-0">"{character.motivation}"</p>
