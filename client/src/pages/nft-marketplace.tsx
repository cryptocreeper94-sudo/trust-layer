...
import genesisNft1 from "@assets/generated_images/genesis_nft_cosmic_orb_collectible.jpg";
import genesisNft2 from "@assets/generated_images/genesis_nft_crystal_formation_collectible.jpg";
import genesisNft3 from "@assets/generated_images/genesis_nft_portal_vortex_collectible.jpg";
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              Buy, sell, and mint unique digital assets on Trust Layer
            </p>
          </motion.div>
