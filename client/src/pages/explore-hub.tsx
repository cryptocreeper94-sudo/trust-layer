...
const categories: Category[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      { label: "TrustGen", description: "AI-powered 3D creation studio", href: "https://trustgen.tlid.io", icon: <Palette className="size-5" />, image: hubAI, glowColor: "shadow-purple-500/30", badge: "Live", featured: true },
    ]
  },
  {
  ...
  },
  {
    ...
    description: "Explore the Trust Layer blockchain — block explorer, validators, network stats, faucet, gas estimator, and domain services.",
    cards: [
  ...
  },
  {
    ...
    cards: [
      ...
      { label: "Learn Center", description: "Academy courses", href: "/learn", icon: <GraduationCap className="size-5" />, image: hubAI, glowColor: "shadow-amber-500/30" },
