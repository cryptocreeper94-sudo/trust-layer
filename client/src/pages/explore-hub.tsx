...
const categories: Category[] = [
  ...
  },
  {
    ...
    description: "Connect with the DarkWave community through Signal Chat, social feeds, team pages, and member directories.",
    cards: [
  ...
  },
  {
    ...
    cards: [
      ...
      { label: "Learn Center", description: "DarkWave Academy courses", href: "/learn", icon: <GraduationCap className="size-5" />, image: hubAI, glowColor: "shadow-amber-500/30" },
