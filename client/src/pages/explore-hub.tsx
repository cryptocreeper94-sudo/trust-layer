...
const categories: Category[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      { label: "Lottery", description: "Lucky number draws", href: "/lottery", icon: <Dices className="size-5" />, image: hubReferral, glowColor: "shadow-teal-500/30" },
    ]
  },
  {
    title: "Earn & Rewards",
    ...
    cards: [
      { label: "Presale", description: "Get SIG at the lowest price", href: "/presale", icon: <Rocket className="size-5" />, image: hubEarn, glowColor: "shadow-teal-500/30", featured: false, badge: "Live" },
