  ...
  return (
    <div className="h-full flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-muted-foreground/60 text-xs mt-1">April 11, 2026</p>
      </div>
    </div>
  );
}
          ...
          >
            ...
            <div className="mb-4 p-3 rounded-xl bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 border border-white/10">
              <div className="flex items-center justify-center gap-2 text-primary">
                ...
                <span className="text-sm font-semibold">Live Trading Available April 11, 2026</span>
              </div>
            </div>
            ...
            >
              ...
              <GlassCard className="p-3">
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-muted-foreground/60 mt-1">April 11, 2026</p>
                </div>
              </GlassCard>
            </motion.div>
          </div>
