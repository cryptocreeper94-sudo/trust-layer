  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/20 selection:text-primary">
        ...
        <div className="w-full px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 sm:gap-3">
            ...
            <Link href="/executive-summary">
              <Button 
                size="sm" 
                className="h-7 sm:h-8 px-1.5 sm:px-3 text-[10px] sm:text-xs font-semibold bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-400 hover:to-purple-400 text-white border-0"
      ...
      <Dialog open={showPresalePopup} onOpenChange={setShowPresalePopup}>
        <DialogContent className="bg-[#0a0f1c] border-2 border-cyan-500/50 text-white max-w-md shadow-[0_0_60px_rgba(0,200,255,0.3)]">
          <DialogHeader>
