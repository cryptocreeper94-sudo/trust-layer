...
const ECOSYSTEM_PHASES: Phase[] = [
  ...
  },
  {
    ...
    image: cyberpunkCity,
    milestones: [
      { id: "cc1", title: "ChronoChat for Communities", description: "Core community platform with channels, reactions, and Shells integration", status: "completed", isRequired: true },
      { id: "cc2", title: "ChronoChat Cloud", description: "SaaS hosting for partner communities ($149+/mo)", status: "in_progress", isRequired: true },
      ...
      { id: "cc5", title: "ChronoChat API", description: "Developer API with rate limits, keys, and documentation", status: "in_progress", isRequired: false },
    ],
  },
  {
    id: "phase-hardening",
