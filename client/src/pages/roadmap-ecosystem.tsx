...
const ECOSYSTEM_PHASES: Phase[] = [
  ...
  },
  {
    ...
    milestones: [
      ...
      { id: "e12", title: "Trust Studio IDE", description: "Monaco-based development environment with 70+ languages", status: "completed", isRequired: true },
      ...
      { id: "e14", title: "Guardian Scanner", description: "AI agent verification + URL/website security scanner with trust scores and certification", status: "completed", isRequired: true },
      { id: "e14b", title: "Guardian Screener", description: "DEX screener with Pulse Safety Engine, ML predictions, snipe buying across 13+ chains", status: "completed", isRequired: true },
  ...
  },
  {
    ...
    image: cyberpunkCity,
    milestones: [
      { id: "cc1", title: "Signal Chat for Communities", description: "Core community platform with channels, reactions, and Shells integration", status: "completed", isRequired: true },
      { id: "cc2", title: "Signal Chat Cloud", description: "SaaS hosting for partner communities ($149+/mo)", status: "in_progress", isRequired: true },
      { id: "cc3", title: "Signal Chat for Gaming", description: "Gaming overlays: matchmaking lobbies, game telemetry, Shells rewards", status: "pending", isRequired: true },
      { id: "cc4", title: "Signal Chat for Teams", description: "Enterprise collaboration with tasks, docs, compliance", status: "pending", isRequired: false },
      { id: "cc5", title: "Signal Chat API", description: "Developer API with rate limits, keys, and documentation", status: "in_progress", isRequired: false },
    ],
  },
  {
    id: "phase-hardening",
    ...
    image: deepSpace,
    milestones: [
      { id: "e19", title: "Security Audits", description: "Third-party smart contract and protocol audits", status: "pending", isRequired: true },
      { id: "e20", title: "Global Validator Network", description: "Transition from single to distributed validator set", status: "pending", isRequired: true },
      { id: "e21", title: "Dedicated Server Clusters", description: "North America, Europe, Asia-Pacific regions", status: "pending", isRequired: true },
      { id: "e22", title: "Governance DAO", description: "On-chain voting for protocol decisions", status: "pending", isRequired: true },
      { id: "e23", title: "Compliance Framework", description: "Legal and regulatory readiness", status: "pending", isRequired: false },
      { id: "e24", title: "24/7 Operations Team", description: "Round-the-clock monitoring and support", status: "pending", isRequired: true },
    ],
  },
  {
    id: "season-zero",
    name: "Season Zero: Chronicles BETA",
    description: "3 starting eras: Modern, Medieval, Wild West — Parallel Self onboarding with AI NPCs",
    status: "in_progress",
    targetDate: "NOW - Community Driven",
    icon: <Gamepad2 className="w-6 h-6" />,
    image: medievalKingdom,
    milestones: [
      { id: "sz1", title: "Season Zero (3 Eras)", description: "Modern (default), Medieval (Lv.3), Wild West (Lv.5) — all playable now", status: "completed", isRequired: true },
      ...
      { id: "sz5", title: "Business Storefront Program", description: "Real businesses claim in-game real estate", status: "in_progress", isRequired: true },
      { id: "sz6", title: "Voice Cloning Technology", description: "ElevenLabs/Resemble.ai NPC voice synthesis", status: "completed", isRequired: true },
    ],
  },
  {
    id: "phase-launch",
