                ...
                {eligibility.eligible ? (
                  <GlassCard className="p-6 border-green-500/30" data-testid="card-eligible">
                    ...
                    <p className="text-xs text-muted-foreground text-center mt-4">
                      Tokens will be distributed at mainnet launch (Apr 11, 2026)
                    </p>
                  </GlassCard>
                ) : (
              ...
              <GlassCard className="p-4" hover={false}>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Tokens are distributed automatically at mainnet launch on April 11, 2026.</p>
                  </div>
                </div>
              </GlassCard>
            </div>
