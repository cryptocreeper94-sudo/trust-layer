      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          >
            ...
            <div className="text-xs text-emerald-400 mt-1">On Trust Layer</div>
          </motion.div>
                ...
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={reserveHistory}>
                      ...
                      />
                      <Area type="monotone" dataKey="locked" stroke="#10b981" fill="#10b981" fillOpacity={0.2} name="Locked SIG" />
                      <Area type="monotone" dataKey="minted" stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.2} name="Minted wSIG" />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </div>
                ...
                <div className="h-48">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      ...
                      <Tooltip 
                        contentStyle={{ backgroundColor: '#1e293b', border: '1px solid #334155', borderRadius: '8px' }}
                        formatter={(value: number) => [value.toLocaleString() + ' wSIG', '']}
                      />
                    </PieChart>
                  </ResponsiveContainer>
                </div>
