          ...
          <GlassCard>
            <div className="p-5">
              <div className="flex items-center gap-2 mb-4">
                ...
                <InfoTooltip content="Hallmarks are unique product IDs stored on DarkWave Trust Layer. Enter a hallmark ID to verify its authenticity and see its on-chain record." label="Hallmark verification info" />
              </div>
