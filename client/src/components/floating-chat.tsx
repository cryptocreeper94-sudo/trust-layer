  ...
  return (
    <>
      <AnimatePresence>
        {isOpen && !isMinimized && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 w-80 sm:w-96 h-[450px] bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl flex flex-col z-50 overflow-hidden"
      ...
      <AnimatePresence>
        {isOpen && isMinimized && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 bg-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-xl shadow-xl px-4 py-2 flex items-center gap-3 z-50"
          >
      ...
      <motion.button
        ...
        className="fixed bottom-4 right-4 w-14 h-14 bg-gradient-to-r from-cyan-600 to-purple-600 rounded-full shadow-lg flex items-center justify-center z-50 hover:scale-110 transition-transform"
