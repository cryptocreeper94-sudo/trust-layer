...
export const ChannelList: React.FC<{ channels: Channel[]; onSelect: (id: string) => void }> = ({ channels, onSelect }) => {
  return (
    <div className="p-3 bg-slate-950/30 rounded-xl border border-slate-800/40" data-testid="channel-list">
      ...
      <div className="space-y-2">
        ...
        <button className="w-full p-2 rounded-md bg-slate-800/40 text-white" data-testid="create-channel">+ Create Channel</button>
      </div>
    </div>
  );
};
