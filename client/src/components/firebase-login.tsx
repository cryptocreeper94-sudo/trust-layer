            ...
            {view === 'providers' && (
              <div className="space-y-3">
                ...
                <div className="relative group">
                  <Button
                    variant="outline"
                    className="w-full h-12 bg-white/5 border-white/10 justify-start gap-3 text-white/50 cursor-not-allowed"
                    disabled={true}
                  ...
                  >
                    ...
                    <span className="ml-auto text-xs bg-cyan-500/20 text-cyan-400 px-2 py-0.5 rounded">Coming Soon</span>
                  </Button>
                  <div className="absolute -bottom-12 left-0 right-0 opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none">
                    <div className="bg-slate-800 border border-white/10 rounded-lg p-2 text-xs text-center text-white/70">
                      Email login will link to Google once enabled
                    </div>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute -bottom-12 left-0 right-0 opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none">
                    <div className="bg-slate-800 border border-white/10 rounded-lg p-2 text-xs text-center text-white/70">
                      Email login will link to GitHub once enabled
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  Apple Sign-In
                  <span className="ml-auto text-xs bg-slate-700/50 px-2 py-0.5 rounded">Coming Soon</span>
                </Button>
              </div>
            )}
